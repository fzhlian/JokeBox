...
This directory now contains a full Stage-model HarmonyOS project scaffold:
...
## Build (DevEco Studio)
1. Open the `harmony/` directory in DevEco Studio.
...
## Notes
- Current bundle name: `com.jokebox.harmony`.
